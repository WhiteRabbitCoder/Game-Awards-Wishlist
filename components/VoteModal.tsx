...
interface Props {
    ...
    onClose: () => void;
    nominee: Nominee;
    onVote: (position: 1 | 2 | 3) => void;
    currentPosition: number | null; // Si ya tiene un voto, saber cuál es
}

export default function VoteModal({ isOpen, onClose, nominee, onVote, currentPosition }: Props) {
                ...
                <div className="p-6 space-y-3">
                    ...
                    >
                        ...
                        <div className="text-left">
                            ...
                            <div className="text-xs opacity-70">Ganador (3 Puntos)</div>
                        </div>
                    </button>
                    ...
                    >
                        ...
                        <div className="text-left">
                            ...
                            <div className="text-xs opacity-70">Runner-up (2 Puntos)</div>
                        </div>
                    </button>
                    ...
                    >
                        ...
                        <div className="text-left">
                            ...
                            <div className="text-xs opacity-70">Mención (1 Punto)</div>
                        </div>
                    </button>

                    {currentPosition && (
                        <button
                            onClick={() => onVote(0 as any)} // 0 para limpiar voto
